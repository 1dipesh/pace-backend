"""Training record synchronization and durable tombstones."""
from alembic import op
import sqlalchemy as sa
revision = "0009_training_sync"
down_revision = "0008_nutrition_sync"
branch_labels = None
depends_on = None


def upgrade():
    op.create_table("training_sync_records",
...
def downgrade():
    op.drop_table("training_sync_records")
